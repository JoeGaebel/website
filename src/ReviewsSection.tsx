...
const Joseph = () => <Review
    ...
    content={<div>
        <div className="block">
            Joe has a very unique gift of being able to drive a team towards success with not only his technical expertise, but also his dynamic energy.
            His passion and excitement for the work he his involved in extends beyond himself as he is always putting the teams success at the forefront.
            He was paramount to the success of our team in critical features we have developed and really led from the front from day one.
            Joe is as technically gifted as they come, and when you combine that with his ability to communicate and engage with people, then you have a very rare gift which he uses to elevate those around him towards success.
        </div>
    </div>
    }
/>
...
const Morgan = () => <Review
    ...
    content={<div>
        <div className="block">
            It’s rare that you come across standout talent like Joe. Joe is always the first and most willing developer to take on the hardest tasks during lengthy sprints. With great enthusiasm and character, Joe ventures through unchartered territory with little guidance proving consistent results. A valued member of our team as both a developer and teammate, I am confident in Joe’s technical capacity as much as I am with his leadership direction amongst the rest of the team to get the job done. My honest opinion is that every development team needs a ‘Joe’.
        </div>
    </div>
    }
/>
